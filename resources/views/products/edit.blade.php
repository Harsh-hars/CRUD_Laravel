    ...
    <div class="container">
        ...
        <div class="row">
            <div class="d-flex p-0 my-2 justify-content-end">
                <a class="bg-dark text-white p-2 text-decoration-none" href="{{ route('products.index') }}">Back</a>
            </div>
            <div class="card p-0">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-3">
                            ...
                            @if (!empty($product->image))
                                <img width="150" src="{{ asset('uploads/products/' . $product->image) }}">
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('sku') is-invalid @enderror" type="text" name="sku"
                                id="sku" placeholder="SKU" value="{{ old('sku', $product->sku) }}">
                            @error('sku')
                                <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
